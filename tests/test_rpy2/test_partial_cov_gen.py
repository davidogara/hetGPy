...
def test_partial_cov_gen_Gauss():
    _test_partial_cov_gen(ctype='Gaussian')

def test_partial_cov_gen_m32():
    _test_partial_cov_gen(ctype='Matern3_2')

def test_partial_cov_gen_m52():
    _test_partial_cov_gen(ctype='Matern5_2')

def _test_partial_cov_gen(ctype):
    X,Z = m['times'], m['accel']
    prep = find_reps(X,Z)
...
if __name__ == "__main__":
    _test_partial_cov_gen('Matern3_2')